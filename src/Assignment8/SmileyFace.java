...
public class SmileyFace extends JComponent implements ActionListener {
    ...
    // Variables for right Eye Brow
    int rightEyeBrowx = 159;
    int righteyeBrowMovement = -1;
    // Variables for left Eye Brow
    int leftEyeBrowx = 159;
    int lefteyeBrowMovement = -1;
    ...
    public void paintComponent(Graphics g) {
        ...
        g.fillRoundRect(430, leftEyeBrowx, 125, 30, 25, 25);
    ...
    public void gameLoop() {
        ...
        if (rightEyeBrowx < 109) {
            righteyeBrowMovement = 1;
        }
        if (rightEyeBrowx > 159) {
            righteyeBrowMovement = -1;
        }
        if (leftEyeBrowx < 109) {
            lefteyeBrowMovement = 1;
        }
        leftEyeBrowx = leftEyeBrowx + lefteyeBrowMovement;
        if (leftEyeBrowx < 109) {
            lefteyeBrowMovement = 1;
        }
        if (leftEyeBrowx > 159) {
